...
| Skill | What it does |
|---|---|
| `research-account` | Builds a full account brief — hiring, funding, M&A, tech stack, and firmographics, plus a call-prep summary — using the prebuilt **Signal Library** signals (`saber signal funding\|mna\|tech\|open-jobs\|firmographics --domain <d>`). |
